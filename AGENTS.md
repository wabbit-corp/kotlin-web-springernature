...
- Canonical repo target: `kotlin-web-springernature`. Useful entrypoints: `dev project show kotlin-web-springernature`, `dev build kotlin-web-springernature`, `dev check kotlin-web-springernature`.
- Setup-managed files are regenerated with `dev setup kotlin-web-springernature`; avoid hand-editing stamped generated files.
