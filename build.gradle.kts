...
// managed-integrity-v1: R8MYBxpg7HJ
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-web-springernature", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-web-springernature")
        description.set("kotlin-web-springernature")
        url.set("https://github.com/wabbit-corp/kotlin-web-springernature")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-web-springernature")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-web-springernature.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-web-springernature.git")
        }
    }
}
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-web-springernature"
...
kotlin {
    ...
    androidLibrary {
        namespace = "one.wabbit.web.springernature"
        compileSdk = 34
        minSdk = 26
    }
        ...
        extensions.findByType(DokkaExtension::class)?.apply {
            ...
            dokkaSourceSets.configureEach {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-web-springernature/tree/master/src")
