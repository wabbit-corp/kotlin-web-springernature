...
publishing {
    publications {
        create<MavenPublication>("maven") {
            groupId = "one.wabbit"
            artifactId = "kotlin-web-springernature"
            version = "0.1.0"
...
kover {
    ...
    //             // title.set("kotlin-web-springernature Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    moduleName.set("kotlin-web-springernature")
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-web-springernature/tree/master/src/main/kotlin")
